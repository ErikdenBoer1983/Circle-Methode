...
const interactieData = {
  ...
  "c2-c1": "C2 kan een diepgaande discussie aangaan om het onderste uit de kan te halen. C1 voelt zich hier erg ongemakkelijk bij. C2 zet C1 nog meer onder druk en als C1 geen tegengas geeft neigt C2 tot forceren van de oplossing. C1 geeft zich gewonnen, voelt zich gefrustreerd, slaat naar 'binnen' en vergeet het incident niet meer. C2 moet van goeden huize komen om het geschade vertrouwen te herstellen.",
  "c2-c2": "Beiden: gaan een diepgaande discussie aan en geven beiden geen strobreed toe; zoeken manieren om van elkaar te winnen, de oplossing zelf wordt niet gezocht; zetten zware druk op de discussie en de zaak kan escaleren; zinnen op wraak als men zich gewonnen moet geven.",
  ...
  "c2-c4": "C2 gaat een diepgaande discussie aan. C4 vraagt tijd om over een goede oplossing na te mogen denken. C2 ervaart dat C4 daardoor de oplossing onnodig ophoudt en drukt door. C4 reageert niet meer als C2 doordrukt en vindt C2 arrogant en te impulsief handelen (zegt dit waarschijnlijk niet).",
  "c2-c5": "C2 gaat een diepgaande discussie aan. C5 vraagt tijd om met anderen over een gezamenlijke oplossing te overleggen. C2 ervaart dat C5 daardoor de oplossing onnodig ophoudt en drukt door. C5 geeft zich gewonnen als C2 doordrukt en vindt C2 arrogant en egoïstisch handelen (zegt dit waarschijnlijk ook).",
  ...
  "c3-c4": "C3 doet, vanuit eigen oplossing, een voorstel, gebaseerd op feiten. C4 geeft aan meer tijd nodig te hebben voor het vinden van een oplossing. C3 draagt nog meer feitelijke onderbouwing aan. C4 raakt overspoeld door \"feitenbombardement\" en haakt af (zegt dit waarschijnlijk niet).",
  ...
  "c3-c6": "C3 voelt zich door C6 aangemoedigd en draagt nog meer feitelijke onderbouwing aan. C6 vindt C3's feitelijke onderbouwing veel te kil en voelt weinig motivatie om oplossing in praktijk te gaan brengen (en zegt dit waarschijnlijk niet). C3 doet, vanuit eigen oplossing, voorstel, gebaseerd op feiten. C6 past zich vrij gemakkelijk aan C3's oplossing aan.",
  ...
  "c4-c2": "C4 doet een uitermate doordacht voorstel. C2 veegt dit voorstel van tafel en doet eigen voorstel. C4 stelt voor rustig de tijd te nemen voor het vinden van de goede oplossing. C2 vindt C4's voorstel niet juist omdat dit te lang duurt en drukt eigen voorstel door.",
  ...
  "c4-c4": "Beiden: doen een uitermate doordacht voorstel; waarderen elkaars denktrant en haasten zich niet; luisteren goed en rustig naar elkaars overwegingen; nemen niet het initiatief om tot een oplossing te komen (er treedt \"radiostilte\" op).",
  ...
  "c6-c2": "C6 doet een voorstel waarbij hij rekening houdt met de gevoelens van C2. C2 legt dat uit als zwakte en probeert zijn voorstel door te drukken. C6 past zich bij tegengas van de ander vrij gemakkelijk aan. C2 is nu helemaal niet meer te houden en walst over C6 heen (dit vindt C6 niet prettig maar hij durft dit waarschijnlijk niet tegen C2 zelf te zeggen; vervolgens bespreekt hij C2's gedrag wel met anderen).",
